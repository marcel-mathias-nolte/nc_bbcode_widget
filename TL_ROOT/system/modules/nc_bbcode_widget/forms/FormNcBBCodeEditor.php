...
/**
 * Class FormNcBBCodeEditor
 *
 * Form field "bbcode".
 */
class FormNcBBCodeEditor extends \Widget
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'form_textarea_bbcode';

	/**
	 * Show label inside textarea and hide on focus
	 * @var string
	 */
	protected $blnShowLabelInside = false;
	...
	public function compile()
	{
		...
		$this->Template->blnShowLabelInside = $this->blnShowLabelInside;
		$this->Template->strPreviewLabel = $GLOBALS['TL_LANG']['MSC']['bbcode_preview'];
		$this->Template->Submit = $this->addSubmit();
